...
# ==============================================================================
# Monta as páginas — embeds + gráficos (mesma lógica do stats.py)
# ==============================================================================
...
class AdminStats(commands.Cog):
    ...
    @app_commands.command(name="admin_stats", description="Get a player's stats from Avalon Games!")
    @app_commands.default_permissions(administrator=True)
    @app_commands.checks.has_permissions(administrator=True)
    @app_commands.guilds(discord.Object(id=GUILD_ID))
    async def admin_stats(self, interaction: discord.Interaction, playername: str):

        player_nick = playername.strip()
    ...
    @admin_stats.error
    async def admin_stats_error(self, interaction: discord.Interaction, error: app_commands.AppCommandError):
...
async def setup(client):
    await client.add_cog(AdminStats(client))