...
from utils_sheets import nomes, load_all_players
...
class ConfirmView(discord.ui.View):
    ...
    async def confirm(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            # 🔄 Recarrega o cache em uma thread separada (não bloqueia o bot)
            await interaction.followup.send("✅ Sheets updated! Reloading stats cache (this may take a minute)...", ephemeral=True)
